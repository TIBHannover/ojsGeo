 ...
 *
 * Patched for OJS 3.3.0-11 to add the `Templates::Issue::TOC::Main` hook
 * that the geoMetadata plugin uses to render its per-issue map section.
 * See README.md "Configure Issue TOC". Mounted into the cypress OJS
 * container via docker-compose-mysql.yml.
 *
